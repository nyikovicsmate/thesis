...
class IterativeSamplingNetwork(Network):
    ...
    def _train(self, x, y, loss_func, epochs, learning_rate, callbacks):
        ...
        assert len(y) == 1, "Iterative sampling is currently only trainable with fixed rates because of the fixed deconv layers."
